...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    List<User> findByFavoriteLocationType(String locationTypeId);
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    List<User> findByFavoriteLocationTypeAlternative(String locationTypeId);

    /**
 * Busca usuario por id cargando su detalle en la misma query (evita problema LAZY en update).
 */
